    ...
    <Card className="group overflow-hidden bg-gradient-card border-border hover:shadow-hover transition-all duration-300 animate-fade-in">
      ...
      <div className="p-4 space-y-3">
        <div className="flex items-start justify-between gap-2">
          <h3 className="text-lg font-semibold text-foreground font-serif line-clamp-1">{item.name}</h3>
        ...
        <div className="flex items-center justify-between pt-2">
          <Badge 
            ...
            className={item.available ? 'bg-primary/10 text-primary hover:bg-primary/20' : ''}
          >
